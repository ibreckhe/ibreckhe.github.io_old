...
- [Full Resolution Data (Fast Laptop)](http://tinyplant.org/RMBL_Drone_Workshop_data_2018.zip)

- [Reduced Resolution Data (Slow Laptop)](http://tinyplant.org/RMBL_Drone_Workshop_data_2018_small.zip)
